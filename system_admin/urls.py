...
urlpatterns = [
    ...
    path('document-repository-delete/', views.DeleteDoc.as_view(), name="documents_repo_delete"),
    ...
    path('sub-folders-delete/', views.DeleteSubFolder.as_view(), name="documents_sub_folders_del"),
